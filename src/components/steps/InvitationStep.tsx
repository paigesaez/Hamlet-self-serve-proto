    ...
    <div className="pt-24 pb-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-5xl lg:text-6xl font-serif font-bold text-gray-900 mb-6 tracking-tight">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
            ...
            <h3 className="font-serif font-bold text-gray-900 mb-2">24-hour alerts</h3>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
            ...
            <h3 className="font-serif font-bold text-gray-900 mb-2">AI-powered matching</h3>
            <p className="text-gray-600 text-sm leading-relaxed">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
            ...
            <h3 className="font-serif font-bold text-gray-900 mb-2">Multi-jurisdiction</h3>
            <p className="text-gray-600 text-sm leading-relaxed">
            ...
            <div className="p-8">
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-[#002147] text-white py-3 px-6 rounded-xl font-medium hover:bg-[#003a6b] transition-all flex items-center justify-center space-x-2 shadow-md hover:shadow-lg"
                >
                  <span>Continue</span>
