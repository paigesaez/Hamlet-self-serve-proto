...
import { MapPin, Search, Plus, Check, ArrowRight, Star, Users, Building, Calendar, CheckCircle, Mail, User, CreditCard, Home, Factory, Zap } from 'lucide-react';
...
export default function InviteBasedFlow() {
  ...
  const TopNavigation = () => (
    <div className="bg-white border-b border-gray-200 px-4 py-3">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        <button
          onClick={resetFlow}
          className="flex items-center space-x-2 text-[#002147] hover:text-[#003a6b] font-medium"
        >
          <Building className="w-5 h-5" />
          <span>Hamlet Agenda Monitoring</span>
        </button>
  ...
  const NavigationButtons = ({ onBack, onNext, backDisabled = false, nextDisabled = false, nextText = "Continue" }) => (
  ...
  const CoverageBuilder = () => {
    ...
    const toggleBody = (locationId, body) => {
      setSelectedBodies(prev => {
      ...
      <div className="bg-white shadow-xl rounded-2xl p-8 border border-gray-200">
        ...
        <div className="space-y-4">
          ...
          <NavigationButtons 
            onBack={() => setStep(12)}
            onNext={() => setStep(14)}
            nextText="Add Billing Info"
            nextDisabled={!email || !email.includes('@')}
          />
        </div>
      </div>
    </div>
      ...
      <div className="bg-white shadow-xl rounded-2xl p-8 border border-gray-200">
        ...
        <div className="space-y-6">
          ...
          <div className="border-t pt-6">
            ...
            <div className="bg-green-50 p-4 rounded-lg mt-6 text-sm">
              <p className="font-medium text-green-900 mb-2">Built for Scale:</p>
              <p className="text-green-800">
                Track multiple cities without adding headcount. Volume discounts available as coverage scales.
              </p>
